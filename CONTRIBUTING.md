...
It's better to discuss an **API** before actually start implementing it. You can open an [**Issue on Github**](https://github.com/pokujs/docker/issues/new), so we can discuss the **API** design implementation ideas.
